                ...
                <div class="container pb35">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <h6 class="font-montserrat text-uppercase color-black">Tentang</h6>
                            <p>Kita adalah sebuah team yang dituntut untuk membuat sistem informasi ini guna memenuhi kebutuhan nilai UAS.</p>
                        </div>
                        <!-- footer about end -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 pull-left">
                            <p>Copyright &copy;2021 <a href="#">SIWIKODE</a>. All rights reserved.</p>
                        </div>
                        <!-- copyright end -->
