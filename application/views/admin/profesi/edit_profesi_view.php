    ...
    <div id="forms">
        <div class="wrap card">
        	<section class="app-content">
        		<div class="row">
        			<div class="col-md-12">
        				<h3>Form Edit Profesi</h3>
        			</div>
        			<div class="col-lg-12">
        				<form action="<?php echo base_url('admin/update_profesi'); ?>" class="form-horizontal" method="POST">
                  <input type="hidden" name="id" value="<?php echo $id ?>">
                  <div class="form-group">
                    <label for="nama" class="col-sm-3">Nama Profesi</label>
                      <div class="col-sm-12">
