    ...
    <div id="forms">
        <div class="wrap card">
        	<section class="app-content">
        		<div class="row">
        			<div class="col-md-12">
        				<h3>Form Tambah Jenis Wisata</h3>
        			</div>
        			<div class="col-lg-12">
        				<form action="<?php echo base_url('admin/save_jenis_wisata'); ?>" class="form-horizontal" method="POST">
                            <div class="form-group">
        						<label for="nama" class="col-sm-3">Nama Jenis Wisata</label>
        						<div class="col-sm-12">
